                    ...
                    if(isset($_POST["submit"]))
                    {
                     ...
                     $origin=$_POST["origin"];
	     					...
	     					$desc=$_POST["desc"];
								...
								$sql= "INSERT INTO `prophetnames` (tables,English,Arabic,Meaning,origin,number,description) VALUES ('$tables','$english','$arabic','$meaning','$origin','$number','$desc')";
								if ($conn->query($sql) === TRUE) {
								    header("location:prophetnames.php");
								} else {
                      ...
                      <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                             ...
                             <div class="modal-body bg-light">
                                  ...
                                  <form class="" method="post" action="prophetnames.php">
                                      <div class="form-group"><input class="form-control" type="hidden"  name="tables" value="prophetnames"/></div>
