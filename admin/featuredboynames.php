                    ...
                    if(isset($_POST["submit"]))
                    {
                     ...
                     $origin=$_POST["origin"];
	     					...
	     					$desc=$_POST["desc"];
								...
								$sql= "INSERT INTO `featuredboynames` (tables,English,Arabic,Meaning,origin,number,description) VALUES ('$tables','$english','$arabic','$meaning','$origin','$number','$desc')";
								  
								if ($conn->query($sql) === TRUE) {
								    header("location:featuredboynames.php");
								} else {
                      ...
                      <div class="table_section padding_infor_info">
                         <div class="table-responsive-sm">
                            <table class="table table_row">
                               ...
                               <tbody>
                               <?php
                              $sql= "SELECT * FROM featuredboynames";
                      ...
                      <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                             ...
                             <div class="modal-body bg-light">
                                  ...
                                  <form class="" method="post" action="featuredboynames.php">
