                    ...
                    if(isset($_POST["submit"]))
                    {
                     ...
                     $origin=$_POST["origin"];
	     					...
	     					$desc=$_POST["desc"];
								...
								$sql= "INSERT INTO `arabicboynames` (tables,English,Arabic,Meaning,origin,number,description) VALUES ('$tables','$english','$arabic','$meaning','$origin','$number','$desc')";
								
								  
								if ($conn->query($sql) === TRUE) {
								    header("location:arabicboynames.php");
								} else {
                   ...
                   <div class="white_shd full margin_bottom_30">
                      ...
                      <div class="table_section padding_infor_info">
                         ...
                         <table class="table table_row">
                               ...
                               <tbody>
                               <?php
                              $sql= "SELECT * FROM arabicboynames";
                      ...
                      <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                             ...
                             <div class="modal-body bg-light">
                                  ...
                                  <form class="" method="post" action="allahnames.php">
                                      <div class="form-group"><input class="form-control" type="hidden"  name="tables" value="allahnames"/></div>
