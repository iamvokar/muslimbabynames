                    ...
                    if(isset($_POST["submit"]))
                    {
                     ...
                     $origin=$_POST["origin"];
	     					...
	     					$desc=$_POST["desc"];
								...
								$sql= "INSERT INTO `popularboynames` (tables,English,Arabic,Meaning,origin,number,description) VALUES ('$tables','$english','$arabic','$meaning','$origin','$number','$desc')";
								if ($conn->query($sql) === TRUE) {
								    header("location:popularboynames.php");
								} else {
       ...
       <div class="row column_title">
          <div class="col-md-12 ">
             <div class="page_title ">
                <h2>Popular Boy Names Tables</h2> 
             </div>
          </div>
       </div>
                   ...
                   <div class="white_shd full margin_bottom_30">
                      ...
                      <div class="table_section padding_infor_info">
                         ...
                         <table class="table table_row">
                               ...
                               <tbody>
                               <?php
                              $sql= "SELECT * FROM popularboynames";
                      ...
                      <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                             ...
                             <div class="modal-body bg-light">
                                  ...
                                  <form class="" method="post" action="popularboynames.php">
                                      <div class="form-group"><input class="form-control" type="hidden"  name="tables" value="popularboynames"/></div>
