                    ...
                    <?php 
                      ...
                      foreach($character as $alphabet)
                      {
                        echo '<li class="page-item">
                                <a href="prophetnames.php?character='.$alphabet.'" class="page-link">'.$alphabet.'</a>
                              </li>';
                      }
                      echo '</ul>';
                      ...
                      <table>
                        <tbody>
                          ...
                          <?php
                           ...
                           $sql = "SELECT * FROM prophetnames WHERE English LIKE '$ch%' ORDER BY id LIMIT {$offset},{$limit} "; 
                    ...
                    <div class="row d-flex justify-content-center ">
                      ...
                      <?php
                         ...
                         if(mysqli_num_rows($result2))
                         {
                           ...
                           {
                            echo '<li class="page-item">
                            <a href="prophetnames.php?page='.$i.'&character='.$ch.'" class="page-link">'.$i.'</a>
                              </li>';
                           }
                           echo '</ul>';
                         }
