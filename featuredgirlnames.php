                ...
                <div class="container-table100 ">
                  <div class="wrap-table100  ">
                    ...
                    <?php 
                      ...
                      foreach($character as $alphabet)
                      {
                        echo '<li class="page-item">
                                <a href="featuredgirlnames.php?character='.$alphabet.'" class="page-link">'.$alphabet.'</a>
                              </li>';
                      }
                      echo '</ul>';
                      ...
                      <table>
                        <tbody>
                          ...
                          <?php
                           ...
                           $sql = "SELECT * FROM featuredgirlnames WHERE English LIKE '$ch%' ORDER BY id LIMIT {$offset},{$limit} "; 
                    ...
                    <div class="row d-flex justify-content-center ">
                      <div class="col-md-12  ">
                      <?php
                         $sql2="SELECT * FROM featuredgirlnames";
                         ...
                         if(mysqli_num_rows($result2))
                         {
                           ...
                           {
                            echo '<li class="page-item">
                            <a href="featuredgirlnames.php?page='.$i.'&character='.$ch.'" class="page-link">'.$i.'</a>
                              </li>';
                           }
                           echo '</ul>';
                         }
